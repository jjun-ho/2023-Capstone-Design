...
//Properties : - use of LU Decomposition
...
//Properties : - Cholesky Decomposition
...
//Properties : set rotation matrix given rotation axis(vR,should be a normalized vector) and angle
//
...
//Properties : set rotation matrix from Rodrigues parameters
//
...
//Properties : set rotation matrix from Euler algles as "R(Z,roll) * R(Y,pitch) * R(X,yaw)"
//
//
